...
class AE_Language extends AE_Base
{
    ...
    function generate_pot() {
        ...
        // $pot->set_header( 'Last-Translator', 'Engine Themes <contact@mtaandao.co.ke>' );
        // $pot->set_header( 'Language-Team', 'Engine Themes <contact@mtaandao.co.ke>' );
    ...
    function generate_mo($file_name) {
        ...
        $mo->set_header('Last-Translator', 'Engine Themes <contact@mtaandao.co.ke>');
        $mo->set_header('Language-Team', 'Engine Themes <contact@mtaandao.co.ke>');
    ...
    function save_language() {
        ...
        foreach ($language_files as $type => $mo) {
            ...
            $mo->set_header('Language-Team', 'MTAANDAO.COM <mtaandao@mtaandao.co.ke>');
