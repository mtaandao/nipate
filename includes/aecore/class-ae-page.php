...
?>
        ...
        <div class="wrap">
            <div class="et-body">
                <div class="et-header">
                    <div class="logo">
                        <a href="http://www.mtaandao.co.ke/"> Powered by <img src="<?php
        echo ae_get_url(); ?>/assets/img/engine-logo.png" /> </a>
                    </div>
                    <div class="slogan"><span><?php
        _e('Theme Administration', ET_DOMAIN) ?></span>.</div>
                </div>
...
class AE_Menu extends AE_Page
{
    ...
    function __construct($pages) {
        ...
        $this->args = array(
            'page_title' => __('Theme Settings', ET_DOMAIN) ,
            'menu_title' => __('Theme Settings', ET_DOMAIN) ,
            'cap' => 'administrator',
            'slug' => 'et-overview',
            'icon_url' => '',
            'pos' => 3
