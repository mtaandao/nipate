...
?>
    ...
    function get_default_options() {
        ...
        return apply_filters('fre_default_setting_option', array(
            ...
            'copyright' => '<span class="mtaandao">Powered by <a href=http://www.mtaandao.co.ke/ >Mtaandao</a> </span>',

            'project_demonstration' => array(
                'home_page' => 'Find hundreds <br/>  of professionals',
                'list_project' => 'Opportunities for all.<br/> Find out more!'
            ) ,
            'profile_demonstration' => array(
                'home_page' => 'Need a job? <br/> Find one here.',
                'list_profile' => 'Skilled/Talented? <br/> Earn now.'
            ) ,
    ...
    function admin_setup() {
        ...
        $pages['settings'] = array(
            'args' => array(
                ...
                'slug' => 'et-settings',
                'icon' => 'y',
                'desc' => __("Manage how your Nipate looks and feels", ET_DOMAIN)
            ) ,
            'container' => $container
        );
